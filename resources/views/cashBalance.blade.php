    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ route('cashBalance.filter') }}" method="POST" class="needs-validation col-md-12" novalidate="">@csrf
              <div class="row">
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                    <thead>
                      ...
                      @endif
                      <tr>
                        <th colspan="8"><h6 class="text-center">Available Cash: Rs. {{number_format($cashBalance)}}</h6></th>
                      </tr>
                      <tr>
                        <th>Sr.</th>
                        <th>Date</th>
