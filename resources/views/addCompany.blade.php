    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ route('company.store') }}" method="POST" class="needs-validation" novalidate="" enctype="multipart/form-data">
              @csrf
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>CEO</label>
                    <input type="text" class="form-control" name="ceo" required value="{{old('ceo')}}">
                    <div class="valid-feedback">Good job!</div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="logoFile" name="logo" accept="image/*">
                      <label class="custom-file-label" for="logoFile">Choose Logo Image</label>
                    </div>
