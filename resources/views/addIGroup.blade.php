    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ route('igroup.store') }}" method="POST" class="needs-validation" novalidate="">
              @csrf
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Group Name</label>
                    <input type="text" class="form-control" name="igroup_no" required>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="igroup_status" required>
                      <option value="1" {{ old('igroup_status') == '1' ? 'selected' : '' }}>Active</option>
                      <option value="0" {{ old('igroup_status') == '0' ? 'selected' : '' }}>Inactive</option>
                    </select>
                    <div class="valid-feedback">Good job!</div>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <label>Date</label>
                    <input type="text" class="form-control datepicker" name="igroup_date" required value="{{old('igroup_date')}}">
                    <div class="valid-feedback">Good job!</div>
                  </div>
                </div>
              </div>
