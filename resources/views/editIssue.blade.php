                ...
                <div class="col-md-5">
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="order_id" id="order_id" required>
                      <option value="" disabled {{ $issue['order_id'] == '' || $issue['order_id'] == null ? 'selected' : '' }}>Select Order</option>
                      <option value="0" {{ $issue['order_id'] == '0' || $issue['order_id'] == 0 ? 'selected' : '' }}>Default Issuance</option>
                      @if($order->count())
