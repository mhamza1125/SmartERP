                ...
                <tbody>
                  @if($work->count())
                    ...
                    <tr>
                      ...
                      <td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal{{$item->work_time_id}}">Edit</button></td>
                    </tr>
                    @endforeach
                  @endif
                </tbody>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="number" min="0" class="form-control" name="grace_time" value="5" required>
                <div class="valid-feedback">Good job!</div>
                <div class="invalid-feedback">Enter Grace Time</div>
              </div>
...
@if($work->count())
  @foreach($work as $item)
    <div class="modal fade" id="exampleModal{{$item->work_time_id}}" tabindex="-1" role="dialog" aria-labelledby="formModal"
      aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <form action="{{ route('work.update', $item->work_time_id) }}" method="POST" class="needs-validation" novalidate=""> @csrf
              <div class="card-body">
                <div class="row">
                  <div class="form-group col-md-6">
                    <label>Date From</label>
                  ...
                  <div class="form-group col-md-4">
                    <label>Time From</label>
                    <input type="time" class="form-control" name="time_from" value="{{$item->time_from}}" required>
                    <div class="valid-feedback">Good job!</div>
                    <div class="invalid-feedback">Enter Date From</div>
                  </div>
                  <div class="form-group col-md-4">
                    <label>Time To</label>
                    <input type="time" class="form-control" name="time_to" value="{{$item->time_to}}" required>
                    <div class="valid-feedback">Good job!</div>
                    <div class="invalid-feedback">Enter Date To</div>
                  </div>
                  <div class="form-group col-md-4">
                    <label>Grace Time (Mins)</label>
                    <input type="number" min="0" class="form-control" name="grace_time" value="{{$item->grace_time}}" required>
                    <div class="valid-feedback">Good job!</div>
                    <div class="invalid-feedback">Enter Grace Time</div>
                  </div>
