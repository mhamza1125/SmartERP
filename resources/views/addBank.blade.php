            ...
            <form action="{{ route('bank.store') }}" method="POST" class="needs-validation" novalidate="">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>IBAN</label>
                    <input type="text" class="form-control" name="iban" placeholder="International Bank Account Number" value="{{old('iban')}}">
                    <div class="valid-feedback">Good job!</div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="branch_code" placeholder="Branch Code" value="{{old('branch_code')}}">
                    <div class="valid-feedback">Good job!</div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="swift_code" placeholder="SWIFT/BIC Code" value="{{old('swift_code')}}">
                    <div class="valid-feedback">Good job!</div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="address" rows="3" placeholder="Bank Address">{{old('address')}}</textarea>
                    <div class="valid-feedback">Good job!</div>
                  </div>
                </div>
              </div>
