              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="return_no" required value="{{$count}}-{{$receive['receive_no']}}" readonly>
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="return_date" required value="{{date('Y-m-d')}}" min="{{$receive['receive_date']}}">
                    <div class="valid-feedback">Good job!</div>
                  </div>
                </div>
                <div class="col-md-2">
