    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ route('box.store') }}" method="POST" class="needs-validation" novalidate="" enctype="multipart/form-data">
              @csrf
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Box No</label>
                    <input type="text" class="form-control" name="box_no" required value="{{old('box_no')}}">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" min="0" step="0.01" name="weight" required value="{{old('weight')}}">
                    <div class="valid-feedback">Good job!</div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="box_status" required>
                      <option value="1" {{ old('box_status') == '1' ? 'selected' : '' }}>Active</option>
                      <option value="0" {{ old('box_status') == '0' ? 'selected' : '' }}>Inactive</option>
                    </select>
                    <div class="valid-feedback">Good job!</div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col">
                        <input type="number" class="form-control" min="0" step="0.01" name="length" placeholder="Length" required value="{{ old('length') }}">
                        <div class="valid-feedback">Good job!</div>
                        <div class="invalid-feedback">Enter Length</div>
                      </div>
                      <div class="col">
                        <input type="number" class="form-control" min="0" step="0.01" name="width" placeholder="Width" required value="{{ old('width') }}">
                        <div class="valid-feedback">Good job!</div>
                        <div class="invalid-feedback">Enter Width</div>
                      </div>
                      <div class="col">
                        <input type="number" class="form-control" min="0" step="0.01" name="height" placeholder="Height" required value="{{ old('height') }}">
                        <div class="valid-feedback">Good job!</div>
