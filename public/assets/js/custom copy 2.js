        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                response.stockItems.forEach(function(item) {
                    var optionText = item.article_no + ' - Size ' + item.sname + ' - ' + item.stname + ' ( ' + (item.stockIn - item.stockOut) + ' ) ';
