...
use App\Repositories\TrasnsactionRepository;
...
class AttendanceController extends Controller
{
    ...
    private function attendance($eid, $dfrom, $dto) {
        ...
        try {
            ...
            if ($eid == 0) {
                $employees = DB::table('employees')->select('attendance_id', 'name', 'salary')->get();
            } else {
                $employees = DB::table('employees')->select('attendance_id', 'name', 'salary')->where('attendance_id', $eid)->get();
            }
